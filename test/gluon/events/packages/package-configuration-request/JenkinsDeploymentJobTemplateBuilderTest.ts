...
describe("buildJenkinsDeploymentJobTemplates", () => {
    it("with single release pipeline should return correct template", async () => {
        ...
        assert.equal(jenkinsDeploymentJobTemplates[0].deploymentEnvironments.postfix, "uat");
        assert.equal(jenkinsDeploymentJobTemplates[0].deploymentEnvironments.displayName, "Demo UAT");
        ...
        assert.equal(jenkinsDeploymentJobTemplates[1].deploymentEnvironments.postfix, "preprod");
        assert.equal(jenkinsDeploymentJobTemplates[1].deploymentEnvironments.displayName, "Demo Pre Prod");
    ...
    it("with multiple release pipeline should return correct template", async () => {
        ...
        assert.equal(jenkinsDeploymentJobTemplates[2].deploymentEnvironments.postfix, "another-uat");
        assert.equal(jenkinsDeploymentJobTemplates[2].deploymentEnvironments.displayName, "Demo Another UAT");
