...
export enum CommandIntent {
    ...
    JenkinsProdCredentialsRecreate = "create jenkins prod credentials",
    ...
    SetPackageJenkinsFolder = "set package jenkins folder",
    UpdateSlackDetails = "update slack details",
}
